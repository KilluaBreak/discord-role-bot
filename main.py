...
ROLE_OPTIONS = [
    ...
    discord.SelectOption(label="vocaloid lovers", value="1381931995373768744"),
    discord.SelectOption(label="art lovers", value="1381932371787386920"),
    discord.SelectOption(label="pengamat server", value="1381932623353610240"),
    discord.SelectOption(label="Free Fire", value="1383003121416011866"),
    discord.SelectOption(label="Mobile Legends", value="1383003591614140477"),
    discord.SelectOption(label="PUBG", value="1383003667178852494"),
    discord.SelectOption(label="Roblox", value="1383003734552084531"),
]
